...
const (
	...
	App_DailyReward_FullMethodName                          = "/api.App/DailyReward"
...
type AppClient interface {
	...
	DailyReward(ctx context.Context, in *DailyRewardRequest, opts ...grpc.CallOption) (*DailyRewardReply, error)
...
func (c *appClient) DailyReward(ctx context.Context, in *DailyRewardRequest, opts ...grpc.CallOption) (*DailyRewardReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DailyRewardReply)
	err := c.cc.Invoke(ctx, App_DailyReward_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppServer interface {
	...
	DailyReward(context.Context, *DailyRewardRequest) (*DailyRewardReply, error)
...
func (UnimplementedAppServer) DailyReward(context.Context, *DailyRewardRequest) (*DailyRewardReply, error) {
...
func _App_DailyReward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DailyRewardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppServer).DailyReward(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: App_DailyReward_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServer).DailyReward(ctx, req.(*DailyRewardRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var App_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _App_DailyReward_Handler,
		},
		{
